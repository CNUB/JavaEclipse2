...
public class StringTest2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("s1과 s2가 같은 장소인가 : " + (s1 == s2));
		System.out.println("s1과 s2가 같은가 : " + (s1.equals(s2)));
		System.out.println("s1과 s3가 같은 장소인가 : " + (s1 == s3));
		System.out.println("s2와 s5가 같은 장소인가 : " + (s2 == s5));
		System.out.println("s2와 s5가 같은가 : " + (s2.equals(s5)));
	}
